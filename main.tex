...
\begin{defin}
  ...
  \begin{enumerate}
    ...
    \item Ist das nicht der Fall, so probiere die nächste Option. Gibt es keine weitere Option mehr, muss es sich um einen invaliden String handeln.
  \end{enumerate}
\end{defin}
...
\begin{enumerate}
  ...
  \item Ist der Exponent eine ganze Zahl:
        \begin{enumerate}
          ...
          \item Ist die Basis eine Potenz, wird die Potenz-Transformation 2 \lab{def:potenz_transformation} angewandt.
          \item Ist die Basis ein Produkt, wird die Potenz-Transformation 3 \lab{def:potenz_transformation} angewandt.
        \end{enumerate}
...
Transformationen in genau dieser Reihenfolge angwendet werden.
\begin{enumerate}
